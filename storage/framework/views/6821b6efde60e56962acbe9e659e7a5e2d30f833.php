            ...
            <h1 class="page-header">Login</h1>
                <div class="row">
                    <div class="col-md-offset-4 col-md-4">
                        <br/>
                        <form method="POST" action="<?php echo e(url('/cek-admin')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php if($errors->has('username-cj')): ?>
                                        <span class="help-block alert-danger">
                                            <strong><?php echo e($errors->first('username-cj')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                    <label>Password</label>
                                    <input type="password" class="form-control" name="password-cj">
                                    <?php if($errors->has('password-cj')): ?>
                                        <span class="help-block alert-danger">
                                            <strong><?php echo e($errors->first('password-cj')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                    <br/>    
