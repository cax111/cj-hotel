			...
			<h1 class="page-header">Login</h1>
                <div class="row">
                    <div class="col-md-offset-4 col-md-4">
                        <br/>
                        <form method="POST" action="<?php echo e(url('/konfirmasi-proses')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                	...
                                	<?php endif; ?>
                                    <label>Token Aktivasi Akun</label>
                                    <input type="text" class="form-control" name="token-confirm" placeholder="Paste Disini...">  
	                                <?php if($errors->has('token-confirm')): ?>
	                                    <span class="help-block alert-danger">
	                                        <strong><?php echo e($errors->first('token-confirm')); ?></strong>
	                                    </span>
	                                <?php endif; ?>
                                    <br/>    
